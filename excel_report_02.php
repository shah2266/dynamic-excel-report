...
class BanglaicxReportController extends Controller
{
    ...
    /**
     * Incoming Excel report
     */
    private $incomingExcel;

    /**
     * Outgoing Excel report
     */
    private $outgoingExcel;

    /**
     * National Excel report
     */
    private $nationalExcel;

    /**
     * Screenshot Excel report
     */
    ...
    /**
     * Report name use in header section
     * @param string
     * @return $reportName
     */
    private $reportName;
    ...
    /**
     * Report date use in header section
     * @param dateTime
     * @return $reportDate
     */
    private $reportDate;
    ...
    /**
     * Worksheet type (Incoming or Outgoing or National)
     * @param object
    ...
    /**
     * Worksheet report header cell coordinate
     * pre-define value 7
     * @return value
     */
    ...
    /**
     * Worksheet report data setup starting cell coordinate
     * pre-define value 8
     * @return value
     */
    ...
    /**
     * Subdays use date wise reports (Incoming or Outgoing or National)
     */
    private $subDays = 30;

    /**
     * Each query result count
     * @param query
     * @return int
     */
    ...
    /**
     * Each schema count from query schema container array
     * @param schema
     * @return int
     */
     ...
     * @return array[]
     */
    private function fontStyle($bold=false, $size=10, $colorCode='000000'): array
    {
        return [
            'font' => [
     ...
     * @return array[][]
     */
    private function thinAndMediumOutlineBorder()
    {
        return [
            'borders' => [
                'allBorders' => [
    ...
    //Report basic information setup
        ...
        for($i = 0; $i < count($worksheetName); $i++) {
            ...
            if($i == 0) {
                ...
                if($worksheetName[$i] != 'Date Wise Chart') {
                    ...
                    continue; //If find 'DateWise Chart' in worksheet titles array, and ignore it
                }
    ...
    public function index() {
        ...
        foreach ($getFiles as $key => $file) {
            ...
            array_push($fileContainer, end($fileData));
        }

        return view('platform.icx.index', compact('fileContainer'));
    }
